    ...
    stages {
        ...
        stage('Deploy'){
           ...
           //    sh '''for pid in $(lsof -t -i:9090); do
             //          kill -9 $pid
             //  done'''
                bat 'Xcopy "C:/ProgramData/Jenkins/.jenkins/workspace/multi_branch_master/bin/Release/netcoreapp3.1/publish/" "C:/inetpub/wwwroot/samplewebapi/publish/" /E/H/C/I'
